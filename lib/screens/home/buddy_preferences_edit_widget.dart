...
class BuddyPreferencesEditWidget extends StatefulWidget {
  final MyUser myUser;
  final UserRepository userRepository;

  BuddyPreferencesEditWidget({
    Key? key,
  ...
  @override
  State<BuddyPreferencesEditWidget> createState() =>
      _BuddyPreferencesEditWidgetState();
}

class _BuddyPreferencesEditWidgetState
    extends State<BuddyPreferencesEditWidget> {
  ...
  void initState() {
    super.initState();
    ageSearchLowController.text = widget.myUser.searchAgeLow == 0
        ? ""
        : widget.myUser.searchAgeLow.toString();
    ageSearchHighController.text = widget.myUser.searchAgeHigh == 0
        ? ""
